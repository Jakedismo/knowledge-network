...
const bodySchema = z.object({ workspaceId: z.string().min(1), id: z.string().min(1), newParentId: z.string().nullable() })
...
export async function POST(req: NextRequest) {
  try {
    ...
    await orgService.moveCollection({ workspaceId: body.workspaceId, userId, id: body.id, newParentId: body.newParentId })
